    ...
    def main(self):
        while self.is_running:
            ...
            if self.start:
                ...
                result_image, lane_angle, lane_x = self.lane_detect(binary_image, image.copy())  # return 변수 추가, the coordinate of the line while the robot is in the middle of the lane
