...
class YoloV5Ros2(Node):
    def __init__(self):
        ...
        self.declare_parameter(
            ...
            ParameterDescriptor(
                name="device",
                description="Compute device selection, default: cpu, options: cuda:0",
            ),
        )
        ...
        self.declare_parameter(
            ...
            ParameterDescriptor(
                name="image_topic",
                description="Image topic, default: /ascamera/camera_publisher/rgb0/image",
            ),
        )
        ...
        self.declare_parameter(
            ...
            ParameterDescriptor(
                name="show_result",
                description="Whether to display detection results, default: False",
            ),
        )
        ...
        self.declare_parameter(
            ...
            ParameterDescriptor(
                name="pub_result_img",
                description="Whether to publish detection result images, default: False",
            ),
        )
    ...
    def image_callback(self, msg: Image):
        ...
        for index in range(len(categories)):
            ...
            if self.show_result or self.pub_result_img:
                ...
                cv2.putText(
                    image,
                    f"{name}:{obj_pose.hypothesis.score:.2f}",
                    (x1, y1),
